...
export const data = new SlashCommandBuilder()
  ...
  .addSubcommand((sub) =>
    sub
      ...
      .addStringOption((opt) => opt.setName('action').setDescription('create|join|leave').setRequired(true))
      .addStringOption((opt) => opt.setName('party_id').setDescription('Party ID (for join)')),
  );
